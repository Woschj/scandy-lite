...
department_id ist die organisatorische "Heimat" des Worker-Datensatzes (wer
verwaltet diesen Datensatz) - NICHT mehr die Quelle für Ausleih-Berechtigungen,
wenn ein Login verknüpft ist. Diese kommen dann von den UserDepartmentRole-
Einträgen des verknüpften Users (siehe app/core/access.py).
"""
import uuid
